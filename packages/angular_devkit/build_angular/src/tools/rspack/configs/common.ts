...
import { Compiler, Configuration, ContextReplacementPlugin, RuleSetRule } from 'webpack';
import { WebpackConfigOptions } from '../../../utils/build-options';
import { allowMangle } from '../../../utils/environment-options';
import { loadEsmModule } from '../../../utils/load-esm';
import { AngularBabelLoaderOptions } from '../../babel/webpack-loader';
import { JavaScriptOptimizerPlugin, JsonStatsPlugin, ScriptsWebpackPlugin } from '../plugins';
import { DedupeModuleResolvePlugin } from '../plugins/dedupe-module-resolve-plugin';
...
export async function getCommonConfig(wco: WebpackConfigOptions): Promise<Configuration> {
  ...
  // TODO: rspack not compatibility with this
